# 1 "/Users/brandonrv/Desktop/Transformada rapida de Furier Proyecto ESP32/nuevo_esp32_read_analog/nuevo_esp32_read_analog.ino"
# 2 "/Users/brandonrv/Desktop/Transformada rapida de Furier Proyecto ESP32/nuevo_esp32_read_analog/nuevo_esp32_read_analog.ino" 2
...
void setup() {
  Serial0.begin(115200); // Configurar la velocidad del puerto serial
  pinMode(adcPin, 0x01); // Configurar el pin ADC como entrada
}
...
void sendBuffer() {
  Serial0.print("Data Start\n");

  for (int i = 0; i < bufferIndex; i++) {
    Serial0.print("ADC2: ");
    Serial0.print(adcBuffer[i]);
    Serial0.print(", Voltaje: ");
    Serial0.println(voltageBuffer[i]);
  }

  Serial0.print("Data End\n");
